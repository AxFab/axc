...
static inline void pop_arg(union __IO_FTYPE *arg, int type, va_list *ap)
{
...
static inline int read_format_specifier (struct _IO_FSPEC *sb, const char **ptr, va_list *ap)
{
  char sign;
  const char *str = *ptr;
